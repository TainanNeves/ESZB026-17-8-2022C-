...
botao3 = QtGui.QPushButton('Diminuir Freq.')
proxy3.setWidget(botao3)
botao3.clicked.connect(diminui_freq)

proxy4 = QtGui.QGraphicsProxyWidget()
botao4 = QtGui.QPushButton('Aumentar Freq.')
proxy4.setWidget(botao4)
botao4.clicked.connect(aumenta_freq)

proxy5 = QtGui.QGraphicsProxyWidget()
botao5 = QtGui.QPushButton('Ler taxa')
proxy5.setWidget(botao5)
botao5.clicked.connect(ler_taxa)
